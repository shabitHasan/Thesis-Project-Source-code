      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4">
            ...
            <div>
              <ul className="mt-2 space-y-2 text-gray-400">
                <li><span className="font-bold ">Phone:</span><span> +880 0143434343</span></li>
                <li><span className="font-bold ">Email:</span><span> shabit@gmail.com</span></li>
                <li className="flex">
                    <a href="#" className="mr-2"><FaFacebookF></FaFacebookF></a>
                    <a href="#" className="mr-2"><FaLinkedinIn></FaLinkedinIn></a>
