  ...
  return (
    <div className="">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-9/12 mx-auto my-20">
        <div className="bg-gray-800 rounded shadow-lg shadow-green-600 bg-gradient-to-r from-gray-800 via-gray-700 to-gray-900">
        ...
        <div className="grid grid-rows-2 gap-4">
          {/* food plan */}
          <div className="bg-gray-800 rounded shadow-lg shadow-green-600 pt-5 bg-gradient-to-r from-gray-800 via-gray-700 to-gray-900">
        ...
        <div className="grid grid-rows-2 gap-4 ">
          <Link
            ...
            className="bg-gray-800 rounded shadow-lg shadow-green-600 py-5 bg-gradient-to-r from-gray-800 via-gray-700 to-gray-900"
          >
            <div className="">
